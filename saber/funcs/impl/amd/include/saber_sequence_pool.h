...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_SEQUENCE_POOL_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_SEQUENCE_POOL_H
...
class SaberSequencePool<AMD, OpDtype>:
      public ImplBase<AMD, OpDtype, SequencePoolParam<AMD> > {
...
public:
    ...
    dispatch(const std::vector<Tensor<AMD>*>& inputs,
            std::vector<Tensor<AMD>*>& outputs,
            SequencePoolParam<AMD>& param) override;
...
private:
    ...
    OpTensor _seq_offset;
};

template class SaberSequencePool<AMD, AK_FLOAT>;

} // namespace saber
} // namespace anakin

#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_SEQUENCE_POOL_H