...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_SOFT_SIGN_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_SOFT_SIGN_H
...
class SaberSoftSign<AMD, OpDtype>:
      public ImplBase<AMD, OpDtype, SoftSignParam<AMD> > {
...
public:
    ...
    dispatch(const std::vector<Tensor<AMD>*>& inputs,
            std::vector<Tensor<AMD>*>& outputs,
            SoftSignParam<AMD>& param) override;
...
template class SaberSoftSign<AMD, AK_FLOAT>;

} // namespace saber
} // namespace anakin

#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_SOFT_SIGN_H