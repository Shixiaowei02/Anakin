...
#ifndef ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_COS_SIM_H
#define ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_COS_SIM_H
...
class SaberCosSim<AMD, OpDtype>:
      public ImplBase<AMD, OpDtype, CosSimParam<AMD> > {
...
public:
    ...
    dispatch(const std::vector<Tensor<AMD>*>& inputs,
            std::vector<Tensor<AMD>*>& outputs,
            CosSimParam<AMD>& param) override;
...
template class SaberCosSim<AMD, AK_FLOAT>;

} // namespace saber
} // namespace anakin

#endif // ANAKIN_SABER_FUNCS_IMPL_AMD_SABER_COS_SIM_H