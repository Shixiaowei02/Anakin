...
#include "include/saber_shuffle_channel.h"
...
SaberStatus SaberShuffleChannel<AMD, OpDtype>::init(
...
template <DataType OpDtype>
SaberShuffleChannel<AMD, OpDtype>::CreateKernelList(int device_id, KernelInfo& kernelInfo) {
...
template <DataType OpDtype>
SaberStatus SaberShuffleChannel<AMD, OpDtype>::create(
    const std::vector<Tensor<AMD>*>& inputs,
    std::vector<Tensor<AMD>*>& outputs,
    ShuffleChannelParam<AMD>& param,
    Context<AMD>& ctx) {
